    ...
    <main>
      <div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
          @foreach ($batiklist as $batik)
          <div class="col">
            <div class="card h-100">
              <img class="card-img-top" src="{{ Storage::url('public/produks/').$batik->gambar_produk }}" width="256px">
              <div class="card-body">
                <h4 class="card-title"> <a href="{{ route('batikshow', $batik->slug )}}"> {{ $batik->nama_usaha }} </a></h4>
                <p class="card-text">{{ $batik->produk }}</p>
              </div>
